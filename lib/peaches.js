 ...
 * @param next(err, styleText)  如果没有错误,err为null, styleText为编译好后的样式.
 * @param spriteName
 * @constructor
 */
function Peaches(styleText, spriteConfig, next, spriteName) {
    ...
    this.options.sprite = _.extend(this.options.sprite, spriteConfig);
    this._init();
}
Peaches.prototype = {
    _init: function () {
        ...
        this.imageBucket.locatImageFile(function () {
            ...
            self.next(null, self.pom.styleSheet.toString());
        });
    }
};
