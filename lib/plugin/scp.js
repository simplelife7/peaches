...
var logger = require('nlogger').logger('plugin/scp');
...
Server.prototype = {
    _init: function () {
        'use strict';
        logger.warn('正在使用scp上传图片到：{} 请确保可以无密码登录，可以google搜索：ssh-copy-id', this.options.server);
    },
