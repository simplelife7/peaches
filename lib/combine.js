...
Combine.prototype = {
    _init: function () {
        ...
        try {
            Sprite = require('./plugin/' + this.peache.options.sprite.name);
        }
        catch (e) {
            Sprite = require('./plugin/nginx');
        }
        this.sprite = new Sprite(this.peache.spriteName, this.peache.options.sprite);
        this.peache.sprite = this.sprite;
        this.drawImage();
